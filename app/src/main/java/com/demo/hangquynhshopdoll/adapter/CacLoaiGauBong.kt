...
import kotlinx.android.synthetic.main.nut_gio_hang.view.*

class CacLoaiGauBong(val menuList: List<Menus?>?, val clickListener: MenuListClickListener): RecyclerView.Adapter<CacLoaiGauBong.MyViewHolder>() {

    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): CacLoaiGauBong.MyViewHolder {
        val view: View = LayoutInflater.from(parent.context).inflate(R.layout.nut_gio_hang, parent, false)
        return MyViewHolder(view)
    }

    override fun onBindViewHolder(holder: CacLoaiGauBong.MyViewHolder, position: Int) {
    ...
    inner class MyViewHolder(view: View): RecyclerView.ViewHolder(view) {
        ...
        fun bind(menus: Menus) {
            ...
            menuPrice.text = "Tổng tiền:  ${menus?.price} VND"
